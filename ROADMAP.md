...
**Stable release: v2.27.0**, published on PyPI, GitHub Releases, Snap, and the APT repo, with
...
On `main` (v2.27.0 plus the unreleased frontier): **147 capabilities (85 wired / 62 honestly
