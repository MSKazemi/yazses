...
**Stable release: v2.21.0**, published on PyPI, GitHub Releases, Snap, and the APT repo, with
...
On `main` (v2.21.0 plus the unreleased frontier): **145 capabilities (83 wired / 62 honestly
marked "planned")**, **4300+ tests green**, ADRs `adr-v2-001..130`, and the per-wave
