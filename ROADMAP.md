...
**Stable release: v2.32.0**, published on PyPI, GitHub Releases, Snap, and the APT repo, with
...
On `main` (v2.32.0 plus the unreleased frontier): **147 capabilities (102 wired / 45 honestly
