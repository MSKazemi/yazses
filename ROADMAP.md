...
**Stable release: v2.28.0**, published on PyPI, GitHub Releases, Snap, and the APT repo, with
...
On `main` (v2.28.0 plus the unreleased frontier): **147 capabilities (85 wired / 62 honestly
