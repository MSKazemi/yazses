...
**Stable release: v2.37.1**, published on PyPI, GitHub Releases, Snap, and the APT repo, with
...
On `main` (v2.37.1 plus the unreleased frontier): **147 capabilities (102 wired / 45 honestly
marked "planned")**, **14800+ tests green**, ADRs `adr-v2-001..134`, and the per-wave
