...
**Stable release: v2.22.0**, published on PyPI, GitHub Releases, Snap, and the APT repo, with
...
On `main` (v2.22.0 plus the unreleased frontier): **145 capabilities (83 wired / 62 honestly
