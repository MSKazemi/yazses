...
**Stable release: v2.40.0**, published on PyPI, GitHub Releases, Snap, and the APT repo, with
...
On `main` (v2.40.0 plus the unreleased frontier): **148 capabilities (103 wired / 45 honestly
