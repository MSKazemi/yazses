...
**Stable release: v2.38.0**, published on PyPI, GitHub Releases, Snap, and the APT repo, with
...
On `main` (v2.38.0 plus the unreleased frontier): **147 capabilities (102 wired / 45 honestly
marked "planned")**, **14800+ tests green**, ADRs `adr-v2-001..144`, and the per-wave
