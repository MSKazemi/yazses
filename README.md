...
- 🤖 **Using Google Jules?** [Connect Jules to your fork step by step](docs/contribute/jules.md). No upstream collaborator access is needed; direct upstream Jules remains gated by #447.
