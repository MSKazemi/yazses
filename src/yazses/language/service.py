...
def candidate_stt(cfg: Config, plan: LanguagePlan) -> SttConfig:
    ...
    # ConfigMutation.after is `object` because a plan carries mutations for every
    # section; narrowing it here would mean re-deriving each key's type. `replace`
    # validates the field names, and configcheck validates the values.
