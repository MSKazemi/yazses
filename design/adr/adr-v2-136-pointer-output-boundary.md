# ADR-v2-136 — Pointer output is a platform boundary, not a Head-Pointer implementation detail

**Status:** Proposed (2026-09-22)  
**Context links:** [[adr-v2-052-head-pointer]], [[adr-v2-030-voice-mouse-grid]], [[adr-v2-135-shared-camera-perception]]
