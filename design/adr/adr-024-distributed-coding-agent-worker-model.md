...
treats a case-insensitive issue label named jules as an execution trigger. Jules user limits are
per account, so independent contributors can provide genuinely independent execution capacity.
...
- reconcile AI authorship vs AI-assistance disclosure;
