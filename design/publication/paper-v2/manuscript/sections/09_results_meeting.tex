...
Table~\ref{tab:ami} reports the four archived clustering conditions. The two
\texttt{max\_speakers=4} rows are identical because the cap, not the distance threshold,
decides the final cluster count once the cap binds.
