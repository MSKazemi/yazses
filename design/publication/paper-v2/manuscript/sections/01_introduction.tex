...
101 to 144 while substitutions, deletions, and hits remained fixed. The earlier engine-matrix run
that triggered the investigation reached 184 insertions and 7.69\% \wer{}. For an offline
benchmark, this appears as movement in aggregate \wer{}. For interactive dictation, it is a different class of failure: a fluent
