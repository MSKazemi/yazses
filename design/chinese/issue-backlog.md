...
**Done when:** ADR-v2-139's evidence gate is resolved with a committed support matrix and result artifacts.
...
- no generic “Chinese supported” statement before ADR-v2-139.
