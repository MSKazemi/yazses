...
If `small` fails release thresholds, ADR-v2-136 must be revisited before support ships.
...
The Mandarin milestone closes only when the release gate in ADR-v2-139 is resolved with a committed evidence report.
