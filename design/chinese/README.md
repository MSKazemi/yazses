...
- [ADR-v2-140 — Language profiles are transactional presets](../adr/adr-v2-140-language-profile-presets.md)
- [ADR-v2-141 — Chinese P1 stays on the existing Whisper engine](../adr/adr-v2-141-chinese-model-policy.md)
- [ADR-v2-142 — Localize command grammars, not command semantics](../adr/adr-v2-142-localized-command-grammars.md)
- [ADR-v2-143 — Separate spoken language, Han script, and locale](../adr/adr-v2-143-chinese-script-and-locale-semantics.md)
- [ADR-v2-144 — Chinese support is gated by measured validation](../adr/adr-v2-144-chinese-support-validation-gate.md)
...
8. **Support claims follow measurements.** Documentation may call Chinese "supported" only after the validation gate in ADR-v2-144 passes.
