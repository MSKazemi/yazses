...
Do not update the Chinese support marketing claim until ADR-v2-139 passes.
...
ASR gates are defined in model strategy and ADR-v2-139.
...
- ADR-v2-135: profile transaction semantics.
- ADR-v2-136: P1 model/runtime decision.
- ADR-v2-137: localized command grammar architecture.
- ADR-v2-138: speech/script/locale semantics.
- ADR-v2-139: support validation gate.
