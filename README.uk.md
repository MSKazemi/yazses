**Read this in other languages:** [English](README.md) · [Deutsch](README.de.md) · [Nederlands](README.nl.md) · [Tiếng Việt](README.vi.md) · [Türkçe](README.tr.md) · [bahasa Indonesia](README.id.md) · [español](README.es.md) · [français](README.fr.md) · [italiano](README.it.md) · [polski](README.pl.md) · [português do Brasil](README.pt-BR.md) · [svenska](README.sv.md) · [čeština](README.cs.md) · [ελληνικά](README.el.md) · [Русский](README.ru.md) · українська · [עברית](README.he.md) · [اردو](README.ur.md) · [العربية](README.ar.md) · [فارسی](README.fa.md) · [हिंदी](README.hi.md) · [বাংলা](README.bn.md) · [தமிழ்](README.ta.md) · [తెలుగు](README.te.md) · [ไทย](README.th.md) · [日本語](README.ja.md) · [简体中文](README.zh-CN.md) · [繁體中文](README.zh-TW.md) · [한국어](README.ko.md)
<!-- yazses-l10n: locale=uk; source=README.md; source_sha=346ba97; scope=partial; status=draft -->

> ⚠️ **Чернетковий переклад** — Створено за допомогою машини й ще не перевірено носієм мови.
>
...
> welcome first contribution — see [issue #204](https://github.com/MSKazemi/yazses/issues/204).*
...
| **Будь-яка система** (Python ≥ 3.11) | `pipx install yazses` |
...
Перший запуск один раз завантажує мовленнєву модель (близько 148 МБ). Після цього мережа взагалі не потрібна.

## Що він робить

- **Диктування** — Утримуйте клавішу, говоріть, відпустіть. Текст вводиться в активне вікно.
- **Голосові команди** — Скажіть «зберегти файл» або «перейти до рядка 40» — і він виконає це, а не надрукує слова.
- **Наради та записи** — Розшифруйте аудіофайл або запишіть цілу нараду з позначенням мовців — усе офлайн.

## Приватність

Звук розшифровується на вашому комп’ютері й ніколи нікуди не надсилається. Немає ані телеметрії, ані шляху до хмари.

## Докладніше

Решта документації наразі англійською.

- [Документація](https://mskazemi.com/yazses/)
- [Повний README англійською](README.md)
- [Питання та звіти](https://github.com/MSKazemi/yazses/issues)
