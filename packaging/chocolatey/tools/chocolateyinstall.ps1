...
$packageArgs = @{
  packageName    = 'yazses'
  fileType       = 'exe'
  url64bit       = 'https://github.com/MSKazemi/yazses/releases/download/v2.35.0/YazSes-2.35.0-windows-x64.exe'
  checksum64     = '9d07af8615f554de3ee641fc4ef611378bbbe7f2f4ad382b5eb8786df37a876c'
