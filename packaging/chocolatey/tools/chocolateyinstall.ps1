...
$packageArgs = @{
  packageName    = 'yazses'
  fileType       = 'exe'
  url64bit       = 'https://github.com/MSKazemi/yazses/releases/download/v2.39.1/YazSes-2.39.1-windows-x64.exe'
  checksum64     = 'ecd353cb00ac6a79b3489f36edf06213a2d051c36c59afec0c2631e8d875b595'
