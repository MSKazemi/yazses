...
$packageArgs = @{
  packageName    = 'yazses'
  fileType       = 'exe'
  url64bit       = 'https://github.com/MSKazemi/yazses/releases/download/v2.25.0/YazSes-2.25.0-windows-x64.exe'
  checksum64     = '0771d081724becf17fda22d61a00257c06761358e49936f1b84d52e4054176ba'
