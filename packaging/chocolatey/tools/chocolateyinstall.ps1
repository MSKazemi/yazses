...
$packageArgs = @{
  packageName    = 'yazses'
  fileType       = 'exe'
  url64bit       = 'https://github.com/MSKazemi/yazses/releases/download/v2.17.0/YazSes-2.17.0-windows-x64.exe'
  checksum64     = 'ece08306544af68f85fcefdf03b8b997b8c0a6db897f05e64fe8edd12f6d1bdf'
