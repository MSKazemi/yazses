...
$packageArgs = @{
  packageName    = 'yazses'
  fileType       = 'exe'
  url64bit       = 'https://github.com/MSKazemi/yazses/releases/download/v2.38.0/YazSes-2.38.0-windows-x64.exe'
  checksum64     = 'af1f8c90c99ff4247d29b315f9074b3b4060a33b5755e390c875e61c52212103'
