...
$packageArgs = @{
  packageName    = 'yazses'
  fileType       = 'exe'
  url64bit       = 'https://github.com/MSKazemi/yazses/releases/download/v2.33.0/YazSes-2.33.0-windows-x64.exe'
  checksum64     = 'de405a7a4fe9a1a48dbf38e284c9cf14040b7eef16f78659743599b606a4366f'
