...
$packageArgs = @{
  packageName    = 'yazses'
  fileType       = 'exe'
  url64bit       = 'https://github.com/MSKazemi/yazses/releases/download/v2.32.0/YazSes-2.32.0-windows-x64.exe'
  checksum64     = '699a963fd3255a2e94fd4699a83236a297e81c57feec57b4f9a2654604296906'
