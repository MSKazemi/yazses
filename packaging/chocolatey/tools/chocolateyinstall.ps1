...
$packageArgs = @{
  packageName    = 'yazses'
  fileType       = 'exe'
  url64bit       = 'https://github.com/MSKazemi/yazses/releases/download/v2.40.0/YazSes-2.40.0-windows-x64.exe'
  checksum64     = '6df6cfb0a601617be4b1187929f10759ddd93d02fbd708611804b4a4b68d440c'
