...
$packageArgs = @{
  packageName    = 'yazses'
  fileType       = 'exe'
  url64bit       = 'https://github.com/MSKazemi/yazses/releases/download/v2.26.0/YazSes-2.26.0-windows-x64.exe'
  checksum64     = '35c48c375d13684c57b65f13129462847bc676533e4982eca50b5bbdd0f723ee'
