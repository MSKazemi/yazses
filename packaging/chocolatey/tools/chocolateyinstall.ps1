...
$packageArgs = @{
  packageName    = 'yazses'
  fileType       = 'exe'
  url64bit       = 'https://github.com/MSKazemi/yazses/releases/download/v2.19.0/YazSes-2.19.0-windows-x64.exe'
  checksum64     = 'caf5e3ad8bedacc008e802c96a4c626340822795d9dfc017914465b5998d2565'
