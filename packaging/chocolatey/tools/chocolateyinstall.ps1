...
$packageArgs = @{
  packageName    = 'yazses'
  fileType       = 'exe'
  url64bit       = 'https://github.com/MSKazemi/yazses/releases/download/v2.36.0/YazSes-2.36.0-windows-x64.exe'
  checksum64     = '6de31b891d20bb35e531b0d47cb057b5b561920d9ae8140a95a2f50cf36b1204'
