...
$packageArgs = @{
  packageName    = 'yazses'
  fileType       = 'exe'
  url64bit       = 'https://github.com/MSKazemi/yazses/releases/download/v2.25.1/YazSes-2.25.1-windows-x64.exe'
  checksum64     = '80125dde9bfa4a3a368d7f94595a9840d291f22fd574de1391ff9e1151ffbc3b'
