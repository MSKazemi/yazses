...
$packageArgs = @{
  packageName    = 'yazses'
  fileType       = 'exe'
  url64bit       = 'https://github.com/MSKazemi/yazses/releases/download/v2.34.0/YazSes-2.34.0-windows-x64.exe'
  checksum64     = '1de53d5639267f1ee040a6abbb7ac79ecbe64bb4aca9659321247987837423f1'
