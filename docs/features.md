...
description: All 139 YazSes capabilities, what each does, and how to turn it on.
---
...
YazSes ships **139 capabilities**. All but the core are **off by default** — turn one on with `yazses features enable <toggle>` and apply with `yazses restart`. Browse them interactively with `yazses features` (grouped) or `yazses features info <toggle>` (one card).

**Tiers:** `core` (always on) · `recommended (on by default)` · `recommended` (safe, worth enabling) · `optional` · `experimental` (rough edges — needs `--force` to enable).
...
- **Toggle:** `wakeword`  ·  **Tier:** experimental — not advised yet  ·  **Config:** `[wakeword] — 'Hey Yaz', experimental`
...
- **Activate:** `yazses features enable wakeword` then `yazses restart`

### Breath-Paced Dictation

- **Toggle:** `breath`  ·  **Tier:** optional  ·  **Config:** `[breath] — segment by natural breath groups`
...
- **Activate:** `yazses features enable breath` then `yazses restart`
...
- **Toggle:** `hesitation`  ·  **Tier:** recommended  ·  **Config:** `[hesitation] — don't cut off filled pauses`
...
- **Activate:** `yazses features enable hesitation` then `yazses restart`
...
- **Toggle:** `autostop`  ·  **Tier:** optional  ·  **Config:** `[autostop] — tap & speak`
...
- **Activate:** `yazses features enable autostop` then `yazses restart`

### Codec Streaming (low latency)

- **Toggle:** `codec`  ·  **Tier:** optional  ·  **Config:** `[codec] — Kyutai/Mimi engine`
...
- **Activate:** `yazses features enable codec` then `yazses restart`
...
- **Toggle:** `involuntary`  ·  **Tier:** optional  ·  **Config:** `[involuntary] — drop coughs & sneezes`
...
- **Activate:** `yazses features enable involuntary` then `yazses restart`
...
- **Toggle:** `reask`  ·  **Tier:** recommended  ·  **Config:** `[reask] — resolve uncertain words`
...
- **Activate:** `yazses features enable reask` then `yazses restart`
...
- **Toggle:** `hotwords`  ·  **Tier:** recommended  ·  **Config:** `[hotwords] — names/jargon actually win`
...
- **Activate:** `yazses features enable hotwords` then `yazses restart`
...
- **Toggle:** `screengrounded`  ·  **Tier:** optional  ·  **Config:** `[screengrounded] — bias from screen`
...
- **Activate:** `yazses features enable screengrounded` then `yazses restart`
...
- **Toggle:** `acoustic_profiles`  ·  **Tier:** optional  ·  **Config:** `[acoustic_profiles] — scene-adaptive`
...
- **Activate:** `yazses features enable acoustic_profiles` then `yazses restart`

### Audio-Anchored Scrubbing

- **Toggle:** `scrub`  ·  **Tier:** optional  ·  **Config:** `[scrub] — replay/pinpoint a word`
...
- **Activate:** `yazses features enable scrub` then `yazses restart`
...
- **Toggle:** `prosodypunct`  ·  **Tier:** recommended  ·  **Config:** `[prosodypunct] — punctuation from prosody`
...
- **Activate:** `yazses features enable prosodypunct` then `yazses restart`
...
- **Toggle:** `affect`  ·  **Tier:** optional  ·  **Config:** `[affect] — tone → !/?`
...
- **Activate:** `yazses features enable affect` then `yazses restart`
...
- **Toggle:** `hatselect`  ·  **Tier:** experimental — not advised yet  ·  **Config:** `[hatselect] — address tokens by spoken label`
...
- **Activate:** `yazses features enable hatselect` then `yazses restart`
...
- **Toggle:** `bookmarks`  ·  **Tier:** optional  ·  **Config:** `[bookmarks] — checkpoints in a long session`
...
- **Activate:** `yazses features enable bookmarks` then `yazses restart`
...
- **Toggle:** `cmdspotter`  ·  **Tier:** optional  ·  **Config:** `[cmdspotter] — enrolled micro-commands`
...
- **Activate:** `yazses features enable cmdspotter` then `yazses restart`

### Ambient Audio-Event Guard

- **Toggle:** `audioguard`  ·  **Tier:** optional  ·  **Config:** `[audioguard] — pause on interruptions`
...
- **Activate:** `yazses features enable audioguard` then `yazses restart`

### Gesture Chords

- **Toggle:** `gesture`  ·  **Tier:** optional  ·  **Config:** `[gesture] — multi-input chords`
...
- **Activate:** `yazses features enable gesture` then `yazses restart`
...
- **Toggle:** `agent`  ·  **Tier:** optional  ·  **Config:** `[agent] — run tools by voice`
...
- **Activate:** `yazses features enable agent` then `yazses restart`

### Voice Pilot (AT-SPI)

- **Toggle:** `pilot`  ·  **Tier:** optional  ·  **Config:** `[pilot] — click by voice`
...
- **Activate:** `yazses features enable pilot` then `yazses restart`
...
- **Toggle:** `langroute`  ·  **Tier:** optional  ·  **Config:** `[langroute] — detect & swap model`
...
- **Activate:** `yazses features enable langroute` then `yazses restart`

### Compose-in-Target-Language

- **Toggle:** `compose`  ·  **Tier:** optional  ·  **Config:** `[compose] — speak L1, type L2`
...
- **Activate:** `yazses features enable compose` then `yazses restart`

### Two-Way Interpreter

- **Toggle:** `interpret`  ·  **Tier:** optional  ·  **Config:** `[interpret] — face-to-face translate`
...
- **Activate:** `yazses features enable interpret` then `yazses restart`

### Pronunciation Feedback

- **Toggle:** `pronunciation`  ·  **Tier:** optional  ·  **Config:** `[pronunciation] — L2 practice`
...
- **Activate:** `yazses features enable pronunciation` then `yazses restart`
...
- **Toggle:** `loadguard`  ·  **Tier:** optional  ·  **Config:** `[loadguard] — cognitive-load guardrails`
...
- **Activate:** `yazses features enable loadguard` then `yazses restart`
...
- **Toggle:** `proofback`  ·  **Tier:** optional  ·  **Config:** `[proofback] — barge-in read-back editing`
...
- **Activate:** `yazses features enable proofback` then `yazses restart`

### Vocal Morse

- **Toggle:** `morsevox`  ·  **Tier:** experimental — not advised yet  ·  **Config:** `[morsevox] — two-tone Morse text entry`
...
- **Activate:** `yazses features enable morsevox` then `yazses restart`

### Mouth-Sound Switch Access

- **Toggle:** `mouthswitch`  ·  **Tier:** experimental — not advised yet  ·  **Config:** `[mouthswitch] — scan-and-select by mouth sounds`
...
- **Activate:** `yazses features enable mouthswitch` then `yazses restart`

### Pitch-Contour Gestures

- **Toggle:** `contour`  ·  **Tier:** experimental — not advised yet  ·  **Config:** `[contour] — hum a shape to run a command`
...
- **Activate:** `yazses features enable contour` then `yazses restart`

### Beam-Steered Spatial VAD

- **Toggle:** `spatialvad`  ·  **Tier:** optional  ·  **Config:** `[spatialvad] — 2-mic direction gate`
...
- **Activate:** `yazses features enable spatialvad` then `yazses restart`

### Vocal Joystick

- **Toggle:** `vocaljoystick`  ·  **Tier:** experimental — not advised yet  ·  **Config:** `[vocaljoystick] — analog cursor control by voice`
...
- **Activate:** `yazses features enable vocaljoystick` then `yazses restart`
...
- **Toggle:** `lipread`  ·  **Tier:** optional  ·  **Config:** `[lipread] — dictate with no voice`
...
- **Activate:** `yazses features enable lipread` then `yazses restart`

### Sign-Language Input

- **Toggle:** `sign`  ·  **Tier:** optional  ·  **Config:** `[sign] — sign to the webcam`
...
- **Activate:** `yazses features enable sign` then `yazses restart`

### Head-Pointer

- **Toggle:** `headpointer`  ·  **Tier:** optional  ·  **Config:** `[headpointer] — cursor by head pose`
...
- **Activate:** `yazses features enable headpointer` then `yazses restart`

### Personal Read-Back Voice

- **Toggle:** `readback_clone`  ·  **Tier:** optional  ·  **Config:** `[tts] clone_voice — your own voice`
...
- **Activate:** `yazses features enable readback_clone` then `yazses restart`

### Vocal-Strain Guard

- **Toggle:** `voicehealth`  ·  **Tier:** optional  ·  **Config:** `[voicehealth] — break reminders`
...
- **Activate:** `yazses features enable voicehealth` then `yazses restart`

### Voice Mouse Grid

- **Toggle:** `mousegrid`  ·  **Tier:** optional  ·  **Config:** `[mousegrid] — click by voice`
...
- **Activate:** `yazses features enable mousegrid` then `yazses restart`
...
- **Toggle:** `sentiment`  ·  **Tier:** optional  ·  **Config:** `[sentiment] — private mood journal`
...
- **Activate:** `yazses features enable sentiment` then `yazses restart`
...
- **Toggle:** `multiprofile`  ·  **Tier:** optional  ·  **Config:** `[voiceprint] multi_profile`
...
- **Activate:** `yazses features enable multiprofile` then `yazses restart`

### Ask My Notes (voice RAG)

- **Toggle:** `rag`  ·  **Tier:** optional  ·  **Config:** `[rag] — cited answers from local docs`
...
- **Activate:** `yazses features enable rag` then `yazses restart`

### Predictive Completion

- **Toggle:** `predict`  ·  **Tier:** optional  ·  **Config:** `[predict] — voice autosuggest`
...
- **Activate:** `yazses features enable predict` then `yazses restart`
...
- **Toggle:** `crowdproof`  ·  **Tier:** experimental — not advised yet  ·  **Config:** `[crowdproof] — dictate in a crowd`
...
- **Activate:** `yazses features enable crowdproof` then `yazses restart`
...
- **Toggle:** `scribe`  ·  **Tier:** optional  ·  **Config:** `[scribe] — who-said-what transcript`
...
- **Activate:** `yazses features enable scribe` then `yazses restart`
...
- **Toggle:** `voiceguard`  ·  **Tier:** experimental — not advised yet  ·  **Config:** `[voiceguard] — experimental`
...
- **Activate:** `yazses features enable voiceguard` then `yazses restart`

### Glasses↔Desktop Bridge

- **Toggle:** `bridge`  ·  **Tier:** experimental — not advised yet  ·  **Config:** `[bridge] — phone/glasses mic, experimental`
...
- **Activate:** `yazses features enable bridge` then `yazses restart`
