---
title: "YazSes — தமிழ்"
description: "YazSes என்பது Linux, macOS மற்றும் Windows-க்கான கட்டணமில்லாத, திறந்த மூல, இணையம் இல்லாமல் இயங்கும் குரல் எழுத்தாக்க சேவை. ஒரு விசையை அழுத்திப் பிடித்து, பேசி, விடுங்கள் — நீங்கள் தட்டச்சு செய்யும் இடத்திலேயே உரை தோன்றும். அனைத்தும் உங்கள் கணினியிலேயே இயங்குகிறது: மேகக்கணி இல்லை, கணக்கு இல்லை, சந்தா இல்லை."
alternates:
  en: index.md
---
...
<!-- yazses-l10n: locale=ta; source=README.md; source_sha=3baacb8; scope=partial; status=draft -->
...
> welcome first contribution — see [issue #351](https://github.com/MSKazemi/yazses/issues/351).*
