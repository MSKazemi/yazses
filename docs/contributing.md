...
| 👁️ **[Eye/camera no-code validation](../design/eye-control/BEGINNER_TESTING.md)** | Pick one 15–20 minute hardware test for Windows, macOS, Wayland, X11 or HiDPI. PASS, FAIL and BLOCKED reports are all useful. |
