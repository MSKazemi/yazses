...
| **Windows, macOS, GNOME/KDE Wayland, X11, or HiDPI hardware** | **[Eye/camera accessibility test](../../design/eye-control/BEGINNER_TESTING.md)** — no code, one small T0/T5 pack, failures wanted | 15–20 min |
