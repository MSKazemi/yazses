...
| **Windows, macOS, GNOME/KDE Wayland, X11, or HiDPI hardware** | **[Eye/camera validation programme](https://github.com/MSKazemi/yazses/blob/main/design/eye-control/BEGINNER_TESTING.md)** — no code; claim only a slot marked READY / `help wanted` | 15–20 min when ready |
