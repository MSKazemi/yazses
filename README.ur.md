**Read this in other languages:** [English](README.md) · [Deutsch](README.de.md) · [Nederlands](README.nl.md) · [Tiếng Việt](README.vi.md) · [Türkçe](README.tr.md) · [bahasa Indonesia](README.id.md) · [español](README.es.md) · [français](README.fr.md) · [italiano](README.it.md) · [polski](README.pl.md) · [português do Brasil](README.pt-BR.md) · [svenska](README.sv.md) · [čeština](README.cs.md) · [ελληνικά](README.el.md) · [Русский](README.ru.md) · [українська](README.uk.md) · [עברית](README.he.md) · اردو · [العربية](README.ar.md) · [فارسی](README.fa.md) · [हिंदी](README.hi.md) · [বাংলা](README.bn.md) · [தமிழ்](README.ta.md) · [తెలుగు](README.te.md) · [ไทย](README.th.md) · [日本語](README.ja.md) · [简体中文](README.zh-CN.md) · [繁體中文](README.zh-TW.md) · [한국어](README.ko.md)

<div dir="rtl">

<!-- yazses-l10n: locale=ur; source=README.md; source_sha=346ba97; scope=partial; status=draft -->

> ⚠️ **مسودۂ ترجمہ** — مشین کی مدد سے کیا گیا ہے اور ابھی کسی مادری بولنے والے نے اس پر نظرثانی نہیں کی۔
>
...
> welcome first contribution — see [issue #232](https://github.com/MSKazemi/yazses/issues/232).*
...
| **کوئی بھی نظام** (Python ≥ 3.11) | `pipx install yazses` |
...
پہلی بار چلانے پر ایک بار تقریر کا ماڈل (تقریباً 148 MB) ڈاؤن لوڈ ہوتا ہے۔ اس کے بعد نیٹ ورک کی بالکل ضرورت نہیں رہتی۔

## یہ کیا کرتا ہے

- **املا** — کلید دبائے رکھیں، بولیں، چھوڑ دیں۔ متن فعال ونڈو میں لکھا جاتا ہے۔
- **آوازی کمانڈز** — کہیے «فائل محفوظ کرو» یا «لائن 40 پر جاؤ» — یہ الفاظ لکھنے کے بجائے کام کر دے گا۔
- **میٹنگز اور ریکارڈنگز** — کسی آڈیو فائل کو متن میں بدلیں، یا پوری میٹنگ بولنے والوں کی نشاندہی کے ساتھ ریکارڈ کریں — سب آف لائن۔

## رازداری

آواز آپ ہی کے کمپیوٹر پر متن میں بدلتی ہے اور کبھی کہیں نہیں بھیجی جاتی۔ نہ کوئی ٹیلی میٹری ہے اور نہ کلاؤڈ تک کوئی راستہ۔

## مزید

باقی دستاویزات فی الحال انگریزی میں ہیں۔

- [دستاویزات](https://mskazemi.com/yazses/)
- [مکمل انگریزی README](README.md)
- [مسائل اور سوالات](https://github.com/MSKazemi/yazses/issues)
